 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 16         |                  | PB00,22| MOSI/EXT1_16    | EIC/EXTINT[6]                        *SERCOM5_ALT/PAD[2]  TC7/WO[0]  GCLK_IO[0]
 * | 17         |                  |  PB02  | MISO/EXT1_17    | EIC/EXTINT[2]  ADC/AIN[10]  PTC/Y[8] *SERCOM5_ALT/PAD[0]  TC6/WO[0]
 * | 18         |                  | PB01,23| SCK/EXT1_18     | EIC/EXTINT[7]                        *SERCOM5_ALT/PAD[3]  TC7/WO[1]  GCLK_IO[1]
 ...
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
 */
  { PORTB,  0, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, PWM7_CH0, TC7_CH0, EXTERNAL_INT_0 }, // SERCOM5_ALT/PAD[2]
  { PORTB,  2, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, PWM6_CH0, TC6_CH0, EXTERNAL_INT_2 }, // SERCOM5_ALT/PAD[0]
  { PORTB,  1, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, PWM7_CH1, TC7_CH1, EXTERNAL_INT_1 }, // SERCOM5_ALT/PAD[3]
